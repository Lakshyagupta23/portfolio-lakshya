...
const LAKSHYA_DB = {
  responses: {
    ...
    eventure: "Eventure is a verified college sponsorship marketplace built on Node.js, Express, and SQL. We won 1st place at the JECRC Bid2Code Hackathon (2024) by solving false sponsorship agreements with a dual-key verification system.",
